...
function QuickHeal_Shaman_FindChainHealSpellToUse(Target, healType, multiplier, forceMaxRank)
    ...
    if not forceMaxRank then
        ...
        --if healneed > (356+healModCH)*hwMod*K and ManaLeft >= 260 *tfMod and maxRankCH >=1 and SpellIDsCH[1] then SpellID = SpellIDsCH[1]; HealSize = (356+healModCH)*hwMod end
        ...
        --if ManaLeft >= 260 *tfMod and maxRankCH >=1 and SpellIDsCH[1] then SpellID = SpellIDsCH[1]; HealSize = (356+healModCH)*hwMod end
...
function QuickHeal_Shaman_FindHealSpellToUse(Target, healType, multiplier, forceMaxHPS)
    ...
    if InCombat then
        ...
        if Health < RatioFull then
            ...
            if healneed > (292+healMod30*PF18)*hwMod*K and ManaLeft >= 155*tfMod and maxRankHW >=4 and downRankNH >=4 and (TargetIsHealthy and maxRankLHW <= 2 and downRankFH <= 2 or NoLHW) and SpellIDsHW[4] then SpellID = SpellIDsHW[4]; HealSize = (292+healMod30*PF18)*hwMod end
            ...
            if healneed > (408+healMod30)*hwMod*K and ManaLeft >= 200*tfMod and maxRankHW >=5 and downRankNH >=5 and healMod30 >=5 and (TargetIsHealthy and maxRankLHW <= 3 and downRankFH <= 3 or NoLHW) and SpellIDsHW[5] then SpellID = SpellIDsHW[5]; HealSize = (408+healMod30)*hwMod end
            ...
            if healneed > (579+healMod30)*hwMod*K and ManaLeft >= 265*tfMod and maxRankHW >=6 and downRankNH >=6 and healMod30 >=6 and (TargetIsHealthy and maxRankLHW <= 4 and downRankFH <= 4 or NoLHW) and SpellIDsHW[6] then SpellID = SpellIDsHW[6]; HealSize = (579+healMod30)*hwMod end
        ...
        if Health < RatioFull then
            SpellID = SpellIDsHW[1]; HealSize = 39*hwMod+healMod15*PF1;
            if healneed > (71+healMod20*PF6)*hwMod and ManaLeft >= 45*tfMod and maxRankHW >=2 and downRankNH >=2 and SpellIDsHW[2] then SpellID = SpellIDsHW[2]; HealSize = (71+healMod20*PF6)*hwMod end
            if healneed > (142+healMod25*PF12)*hwMod and ManaLeft >= 80*tfMod and maxRankHW >=3 and downRankNH >=3 and SpellIDsHW[3] then SpellID = SpellIDsHW[3]; HealSize = (142+healMod25*PF12)*hwMod end
            ...
            if healneed > (292+healMod30*PF18)*hwMod and ManaLeft >= 155*tfMod and maxRankHW >=4 and downRankNH >=4 and SpellIDsHW[4] then SpellID = SpellIDsHW[4]; HealSize = (292+healMod30*PF18)*hwMod end
...
function QuickHeal_Shaman_FindHealSpellToUseNoTarget(maxhealth, healDeficit, healType, multiplier, forceMaxHPS, forceMaxRank, hdb, incombat)
    ...
    if forceMaxHPS then
        ...
        SpellID = SpellIDsHW[1]; HealSize = (39+healMod15*PF1)*hwMod;
        if healneed > (71+healMod20*PF6)*hwMod and ManaLeft >= 45*tfMod and maxRankHW >=2 and downRankNH >=2 and SpellIDsHW[2] then SpellID = SpellIDsHW[2]; HealSize = (71+healMod20*PF6)*hwMod end
        if healneed > (142+healMod25*PF12)*hwMod and ManaLeft >= 80*tfMod and maxRankHW >=3 and downRankNH >=3 and SpellIDsHW[3] then SpellID = SpellIDsHW[3]; HealSize = (142+healMod25*PF12)*hwMod end
        if healneed > (174+healModLHW)*hwMod and ManaLeft >= 105*tfMod and maxRankLHW >=1 and downRankFH >=1 and SpellIDsLHW[1] then SpellID = SpellIDsLHW[1]; HealSize = (174+healModLHW)*hwMod end
        if healneed > (264+healModLHW)*hwMod and ManaLeft >= 145*tfMod and maxRankLHW >=2 and downRankFH >=2 and SpellIDsLHW[2] then SpellID = SpellIDsLHW[2]; HealSize = (264+healModLHW)*hwMod end
